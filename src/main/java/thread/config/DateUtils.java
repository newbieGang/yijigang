...
public class DateUtils {
     ...
     * 格式化年月日
     */
    private static SimpleDateFormat format_yyyy_mm_dd = new SimpleDateFormat(
            YYYY_MM_DD);
    /**
     * 格式化年月
     */
     ...
     *
     */
    public static String dateToFormatString(Date dDate, String sFormat) {
        if (dDate == null) {
            return "";
        } else {
    ...
    /**
     *
     * 将字符串按指定格式转换为Date类型，format的取值在类中定义了常量，默认格式为yyyy-MM-dd HH:mm:ss
     * @param str 待转化的字符串
     * @param format 指定格式
    ...
    /**
     * 根据给定的格式，返回时间字符串
     * 参照DateFormator类，是调用了DateFormator类的dateToFormatString方法。
     * @param format 日期格式字符串
     * @return String 指定格式的日期字符串.
     */
    public static String getFormatCurrentTime(String format) {
        return dateToFormatString(new Date(), format);
    }
    ...
    public static String getFirstDateOfMonth(String strYYYYMMDD) {
        Calendar caldTmp = Calendar.getInstance();
        // 取得该月第一天日期
        caldTmp.set(DateUtils.getIntYearOfDate(strYYYYMMDD),
                DateUtils.getIntMonthOfDate(strYYYYMMDD) - 1, 1);
        return DateUtils.dateToFormatString(caldTmp.getTime(), DateUtils.YYYY_MM_DD);
    }
    ...
    public static String getLastDateOfMonth(String strYYYYMMDD) {
        ...
        return dateToFormatString(caldTmp.getTime(), YYYY_MM_DD);
    }
    ...
    public static String getSundayOfThisWeek(String strYYYYMMDD) {
        ...
        return dateToFormatString(getOffsetDate(strThisWeekFirstDate, 6, "day"),
                YYYY_MM_DD);
    }
    ...
    public static String getMondayOfWeek(String strYYYYMMDD, int weekIndex) {
        ...
        String tmpDate = dateToFormatString(caldTmp.getTime(), "yyyy-MM-dd");
    ...
    public static int getWeekIndexOfMonth(String strYYYYMMDD) {
        ...
        // 取得上月最后一周的sunday
        // 上月最后一天
        String strLastDateOfPreMonth = dateToFormatString(
        ...
        Date dParam = formatStringTODate(strYYYYMMDD, YYYY_MM_DD);
        Date dSundayOfLastWeekOfPreMonth = formatStringTODate(strSundayOfLastWeekOfPreMonth);
        ...
        if (nDateDiffNoTime <= 0) {
            ...
            Date dTmp = formatStringTODate(strYYYYMMDD, YYYY_MM_DD);
            String strStdYYYYMMDD = dateToFormatString(dTmp, YYYY_MM_DD);
            if (strStdYYYYMMDD
                ...
                Date dFistDayOfThisMonth = formatStringTODate(strFirstDayOfThisMonth,
                        YYYY_MM_DD);
    ...
    public static String[] getDayList(String beginDate, String endDate) {
        ...
        while (bDate.compareTo(eDate) <= 0) {
            tmpDate = dateToFormatString(bDate, "yyyy-MM-dd");
    ...
    public static String getToday() {
        return DateUtils.dateToFormatString(new Date(), DateUtils.YYYY_MM_DD);
    }
    ...
    public static String lastFewDay(int n) {
        ...
        return DateUtils.dateToFormatString(cal.getTime(), DateUtils.YYYY_MM_DD);
    }
    ...
    public static String lastFewMon(int n) {
        ...
        return DateUtils.dateToFormatString(cal.getTime(), DateUtils.YYYY_MM);
    }
     ...
     */
    public static Date getStepMonth(Date date, int intBetween) {
     ...
     */
    public static Date getStepYear(Date date, int intBetween) {
        Calendar calo = Calendar.getInstance();
        calo.setTime(date);
    ...
    public static void main(String args[]) {
        try {
            System.out.println(DateUtils.nextDate(new SimpleDateFormat("yyyy-MM-dd").parse("2018-07-20"),1));
        } catch (ParseException e) {
